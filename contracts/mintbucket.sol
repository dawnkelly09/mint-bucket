//contracts/mintbucket.sol
// SPDX-License-Identifier: UNLICENSED

//deployed to Mumbai testnet: 0x7c74593debaa5aa15d4426301132371f25576a2b
...
contract MintBucketNFT is ERC721URIStorage {
    ...
    */
    ...
    constructor() ERC721("MintBucket NFT", "Mint your moments") {
        

        //no need to limit # of NFTs
    ...
    function mintMyNFT(string memory ipfsURI) public returns (uint256) {
        ...
        //not using a maxNFT for this one, no limit on how many images user can mint
    ...
    //not using max nfts for this project
